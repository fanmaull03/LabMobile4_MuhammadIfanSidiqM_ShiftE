...
class _ProdukFormState extends State<ProdukForm> {
  ...
  // Tombol Simpan/Ubah pada ProdukForm
  // Tombol Simpan/Ubah pada ProdukForm
  Widget _buttonSubmit() {
    return OutlinedButton(
      ...
      onPressed: () {
        ...
        if (validate) {
          if (widget.produk == null) {
            // Jika produk baru, buat produk baru
            ...
            // Kembalikan produk baru ke halaman sebelumnya
            Navigator.pop(context, produkBaru);
          } else {
            // Logika untuk mengubah produk yang ada
            widget.produk!.kodeProduk = _kodeProdukTextboxController.text;
            widget.produk!.namaProduk = _namaProdukTextboxController.text;
            widget.produk!.hargaProduk =
                int.parse(_hargaProdukTextboxController.text);

            // Kembalikan produk yang diubah ke halaman sebelumnya
